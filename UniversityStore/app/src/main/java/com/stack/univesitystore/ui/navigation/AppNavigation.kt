package com.stack.univesitystore.ui.navigation
...
import com.stack.univesitystore.ui.screens.PerfilScreen
import com.stack.univesitystore.ui.screens.TiendaScreen
...
sealed class Ruta(
    ...
    data object Favoritos : Ruta("favoritos", "Favoritos", Icons.Filled.Store)
}

private val pestañas = listOf(Ruta.Tienda, Ruta.Perfil, Ruta.Favoritos)
